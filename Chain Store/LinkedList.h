...
/*
 * Requirements for type T used with LinkedList:
 * 1. T must have copy constructor and copy assignment operator 
 * 2. T must have equality operator (operator==)
 * 3. T must have an output operator (overloaded operator<<)
 * 4. T have destructor
 * Note: If T is a pointer type, the user is responsible for proper memory management
 */
...
public:
    ...
    void print() const;                     // Displays all elements in the list
